...
/**
 * Array configuration field with countries and the customs reference number.
 *
 * The country dropdown is rendered per row using a separate form field.
 * @see \Dhl\Paket\Block\Adminhtml\System\Config\Form\Field\Country
 */
class CustomsReference extends AbstractFieldArray
{
    /**
     * @var Country
     */
